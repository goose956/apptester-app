      ...
      <div className="text-center">
        ...
        <div className="mt-5 max-w-md mx-auto sm:flex sm:justify-center md:mt-8">
          ...
          <div className="mt-3 rounded-md shadow sm:mt-0 sm:ml-3">
            <a
              href="/contact"
              className={`w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md bg-white hover:bg-gray-50 md:py-4 md:text-lg md:px-10 text-blue-600`}
            >
              Get Started
            </a>
          </div>
        ...
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div className="pt-6">
            <div className="flow-root bg-white rounded-lg px-6 pb-8">
              <div className="-mt-6">
                <div className={`inline-flex items-center justify-center p-3 rounded-md shadow-lg bg-blue-600`}>
                ...
                <p className="mt-5 text-base text-gray-500">
                  Crafted with attention to detail for apptester.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-6">
            <div className="flow-root bg-white rounded-lg px-6 pb-8">
              <div className="-mt-6">
                ...
                <p className="mt-5 text-base text-gray-500">
                  Built to deliver consistent performance for apptester users.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="pt-6">
            <div className="flow-root bg-white rounded-lg px-6 pb-8">
              <div className="-mt-6">
                ...
                <p className="mt-5 text-base text-gray-500">
                  apptester brings cutting-edge features to enhance your experience.
                </p>
              </div>
            </div>
          </div>
